...
-- CreateIndex
CREATE UNIQUE INDEX "Event_user_key" ON "Event"("user");
...
-- AddForeignKey
ALTER TABLE "Event" ADD CONSTRAINT "Event_user_fkey" FOREIGN KEY ("user") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
